    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{ asset('./public/images/profile/'.Auth::user()->profile_image .'') }}">
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#Selltings">
        ...
        function settings(){
            ...
            var CSRF_TOKEN = $('input[name="_token"]').val();
                ...
                $.ajax({
                    ...
                    method:'POST',
                    data:{'currency':currency,'tax':tax,'delivery_charge':delivery_charge},
                    dataType:"json",
                    success:function(data){
                      $('#preloader').hide();
                        $("#loading-image").hide();
