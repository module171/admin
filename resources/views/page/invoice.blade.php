        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-sm-8">
                    <h6 class="mb-3">To:</h6>
                    <div>
                        <strong>{{$getusers['user']->name}}</strong>
                    </div>
                    <div>{{$getusers->address}}</div>
                    <div>Email: {{$getusers['user']->email}}</div>
                    <div>Phone: {{$getusers['user']->mobile}}</div>
                </div>
            ...
            <div class="table-responsive-sm">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $i=1;
                        foreach ($getorders['itemorder'] as $orders) {
                        ?>
                        <tr>
                            ...
                            <td class="left strong">
                                ...
                                @foreach ($getorders['topping'] as $topping)
                            ...
                            <td class="right"><?php echo env('CURRENCY'); ?>{{number_format($getorders['order']->order_total, 2)}}</td>
                        </tr>
                        <?php
                            $data[] = array(
                    ...
                    <table class="table table-clear">
                        <tbody>
                            <tr>
                                ...
                                <td class="right">
                                    <strong><?php echo env('CURRENCY').''.number_format($getusers->discount_tax, 2); ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="left">
                            ...
                            <tr>
                                <td class="left">
                                    <strong>Discount</strong> ({{$getusers->promotecode}})
                                </td>
                                <td class="right">
